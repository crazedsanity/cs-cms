...
//			cs_debug_backtrace(1);
		...
		self::$version->set_version_file_location($versionFileLocation);
		...
		$this->projectName = self::$version->get_project();
...
//		$this->read_version_file();
	...
	public function is_higher_version($version, $checkIfHigher) {
		try {
			$retval = self::$version->is_higher_version($version, $checkIfHigher);
		}
		catch(exception $e) {
